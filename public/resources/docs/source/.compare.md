...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"reiciendis","ip_address":"facilis","latitude":"et","longitude":"praesentium"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"maxime","latitude":"eum","longitude":"nemo"}'
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/holidays?location_id=cum&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=dicta&follow_up_type=voluptatem&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=veritatis&biz_name=iusto&mobile_num=3&contact_id=corrupti&order_by=excepturi&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"quasi","mobile_name":"aliquam","call_type":"call","start_time":"repellendus","end_time":"officia","duration":"recusandae"}]}'
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=rerum&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":17,"initial_amount":522.02,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":2.5,"total_card_slips":10,"total_cheques":10,"closing_note":"quis","transaction_ids":"1,2,3"}'
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/contactapi?type=aut&name=et&biz_name=adipisci&mobile_num=13&contact_id=totam&order_by=cumque&direction=quis&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"velit","prefix":"molestiae","first_name":"assumenda","middle_name":"quia","last_name":"iure","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"non","address_line_2":"est","city":"excepturi","state":"facere","country":"deserunt","zip_code":"magni","customer_group_id":"deleniti","contact_id":"magni","dob":"2000-06-13","custom_field1":"ab","custom_field2":"rerum","custom_field3":"et","custom_field4":"ipsam","email":"ipsam","shipping_address":"sed","position":"et","opening_balance":0,"source_id":13,"life_stage_id":7,"assigned_to":[]}'
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"aut","prefix":"quae","first_name":"dolor","middle_name":"aut","last_name":"hic","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"explicabo","address_line_2":"dignissimos","city":"iste","state":"at","country":"quia","zip_code":"sed","customer_group_id":"porro","contact_id":"rerum","dob":"2000-06-13","custom_field1":"provident","custom_field2":"in","custom_field3":"nemo","custom_field4":"sapiente","email":"blanditiis","shipping_address":"quod","position":"eum","opening_balance":10.3,"source_id":14,"life_stage_id":19,"assigned_to":[]}'
...
let body = {
    ...
    "address_line_2": "dignissimos",
    "city": "iste",
    "state": "at",
    "country": "quia",
    "zip_code": "sed",
    "customer_group_id": "porro",
    "contact_id": "rerum",
    "dob": "2000-06-13",
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":12,"card_number":"dolorum","card_holder_name":"nisi","card_transaction_number":"modi","card_type":"animi","card_month":"repellat","card_year":"veniam","card_security":"amet","transaction_no_1":"molestiae","transaction_no_2":"quia","transaction_no_3":"qui","cheque_number":"illum","bank_account_number":"minima","note":"facilis"}'
...
let body = {
    ...
    "card_transaction_number": "modi",
    "card_type": "animi",
    "card_month": "repellat",
    "card_year": "veniam",
    "card_security": "amet",
    "transaction_no_1": "molestiae",
    "transaction_no_2": "quia",
    "transaction_no_3": "qui",
    "cheque_number": "illum",
    "bank_account_number": "minima",
    "note": "facilis"
}
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/expense?location_id=enim&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=earum&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":10,"final_total":3168496.397,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":5,"expense_for":17,"contact_id":18,"additional_notes":"pariatur","is_refund":0,"is_recurring":0,"recur_interval":16,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"animi","recur_repetitions":10,"payment":[{"amount":453.13,"method":"cash","account_id":8,"card_number":"id","card_holder_name":"illum","card_transaction_number":"suscipit","card_type":"numquam","card_month":"ex","card_year":"aut","card_security":"totam","transaction_no_1":"necessitatibus","transaction_no_2":"unde","transaction_no_3":"nihil","note":"dolorem","cheque_number":"veniam"}]}'
...
let body = {
    "location_id": 10,
    "final_total": 3168496.397,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 5,
    "expense_for": 17,
    "contact_id": 18,
    "additional_notes": "pariatur",
    "is_refund": 0,
    "is_recurring": 0,
    "recur_interval": 16,
    ...
    "payment": [
        {
            ...
            "account_id": 8,
            "card_number": "id",
            "card_holder_name": "illum",
            "card_transaction_number": "suscipit",
            "card_type": "numquam",
            "card_month": "ex",
            "card_year": "aut",
            "card_security": "totam",
            "transaction_no_1": "necessitatibus",
            "transaction_no_2": "unde",
            "transaction_no_3": "nihil",
            "note": "dolorem",
            "cheque_number": "veniam"
        }
    ]
}
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":15.60451,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":20,"expense_for":1,"contact_id":3,"additional_notes":"totam","is_recurring":0,"recur_interval":13,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"impedit","recur_repetitions":10,"payment":[]}'
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/expense-refund?location_id=dolorum&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=tempora&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/product?order_by=eveniet&order_direction=sed&brand_id=ex&category_id=temporibus&sub_category_id=et&location_id=et&selling_price_group=necessitatibus&name=magni&sku=quo&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/product/1?selling_price_group=libero" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/variation/2?product_id=suscipit&location_id=voluptas&brand_id=nulla&category_id=velit&sub_category_id=consequatur&not_for_selling=nulla&name=ab&sku=sapiente&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/sell?location_id=doloribus&contact_id=dicta&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=modi&service_staff_id=ut&shipping_status=ordered&only_subscriptions=molestias&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":19,"contact_id":20,"transaction_date":"2020-07-22 15:48:29","invoice_no":"quos","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":2,"discount_amount":10,"discount_type":"fixed","sale_note":"tempore","staff_note":"reprehenderit","commission_agent":2,"shipping_details":"Express Delivery","shipping_address":"est","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":10,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":4,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"velit","recur_repetitions":10,"rp_redeemed":20,"rp_redeemed_amount":13.5,"types_of_service_id":5,"service_custom_field_1":"cum","service_custom_field_2":"perferendis","service_custom_field_3":"quam","service_custom_field_4":"praesentium","service_custom_field_5":"quasi","service_custom_field_6":"reiciendis","round_off_amount":1368786.945534,"table_id":17,"service_staff_id":5,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":4,"note":"laudantium"}],"payments":[{"amount":453.13,"method":"cash","account_id":13,"card_number":"eos","card_holder_name":"dolor","card_transaction_number":"fugiat","card_type":"rem","card_month":"est","card_year":"sed","card_security":"dolor","transaction_no_1":"totam","transaction_no_2":"perferendis","transaction_no_3":"quidem","bank_account_number":"sunt","note":"fugiat","cheque_number":"vel"}]}]}'
    ...
    "sells": [
        {
            ...
            "service_custom_field_1": "cum",
            "service_custom_field_2": "perferendis",
            "service_custom_field_3": "quam",
            "service_custom_field_4": "praesentium",
            "service_custom_field_5": "quasi",
            "service_custom_field_6": "reiciendis",
            "round_off_amount": 1368786.945534,
            "table_id": 17,
            "service_staff_id": 5,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_year": "sed",
                    "card_security": "dolor",
                    "transaction_no_1": "totam",
                    "transaction_no_2": "perferendis",
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":20,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":9,"discount_amount":10,"discount_type":"fixed","sale_note":"laudantium","staff_note":"maxime","sells":[{"is_suspend":false}],"commission_agent":3,"shipping_details":"Express Delivery","shipping_address":"asperiores","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":7,"pay_term_number":6,"pay_term_type":"months","is_recurring":0,"recur_interval":6,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"magnam","recur_repetitions":5,"rp_redeemed":16,"rp_redeemed_amount":13.5,"types_of_service_id":9,"service_custom_field_1":"eum","service_custom_field_2":"ex","service_custom_field_3":"ut","service_custom_field_4":"at","service_custom_field_5":"consectetur","service_custom_field_6":"maiores","round_off_amount":704932687.587721,"table_id":5,"service_staff_id":9,"change_return":0,"change_return_id":5,"products":[{"sell_line_id":15,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":15,"discount_amount":0,"discount_type":"percentage","sub_unit_id":11,"note":"omnis"}],"payments":[{"payment_id":2,"amount":453.13,"method":"cash","account_id":10,"card_number":"sed","card_holder_name":"amet","card_transaction_number":"asperiores","card_type":"modi","card_month":"consequatur","card_year":"voluptate","card_security":"in","transaction_no_1":"vero","transaction_no_2":"qui","transaction_no_3":"repellat","note":"quam","cheque_number":"enim","bank_account_number":"quia"}]}'
...
let body = {
    ...
    "service_custom_field_4": "at",
    "service_custom_field_5": "consectetur",
    "service_custom_field_6": "maiores",
    "round_off_amount": 704932687.587721,
    "table_id": 5,
    "service_staff_id": 9,
    "change_return": 0,
    "change_return_id": 5,
    ...
    "payments": [
        {
            ...
            "card_transaction_number": "asperiores",
            "card_type": "modi",
...
```bash
curl -X DELETE \
    "https://ultimate-pos.dev/connector/api/sell/aut" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":6,"transaction_date":"2020-5-7 15:20:22","invoice_no":"enim","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":4,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":15,"shipping_status":"ordered","delivered_to":"eos"}'
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/table?location_id=suscipit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/taxonomy?type=dolor" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"deleniti","first_name":"quis","last_name":"vero","email":"ea","is_active":"ut","user_type":"sit","crm_contact_id":15,"allow_login":true,"username":"doloribus","password":"alias","role":15,"access_all_locations":true,"location_permissions":[],"cmmsn_percent":"consequatur","max_sales_discount_percent":"qui","selected_contacts":false,"selected_contact_ids":[],"dob":"voluptatem","gender":"ut","marital_status":"adipisci","blood_group":"enim","contact_number":"aut","alt_number":"labore","family_number":"ex","fb_link":"provident","twitter_link":"ratione","social_media_1":"odit","social_media_2":"distinctio","custom_field_1":"ut","custom_field_2":"rerum","custom_field_3":"vitae","custom_field_4":"odio","guardian_name":"ut","id_proof_name":"repudiandae","id_proof_number":"reiciendis","permanent_address":"beatae","current_address":"molestiae","bank_details":[{"account_holder_name":"qui","account_number":"aut","bank_name":"id","bank_code":"rerum","branch":"eum","tax_payer_id":"reprehenderit"}]}'
...
let body = {
    ...
    "dob": "voluptatem",
    "gender": "ut",
    "marital_status": "adipisci",
    "blood_group": "enim",
    "contact_number": "aut",
    "alt_number": "labore",
    "family_number": "ex",
    "fb_link": "provident",
    "twitter_link": "ratione",
    "social_media_1": "odit",
    "social_media_2": "distinctio",
    "custom_field_1": "ut",
    "custom_field_2": "rerum",
    "custom_field_3": "vitae",
    "custom_field_4": "odio",
    "guardian_name": "ut",
    "id_proof_name": "repudiandae",
    "id_proof_number": "reiciendis",
    "permanent_address": "beatae",
    "current_address": "molestiae",
    "bank_details": [
        {
            "account_holder_name": "qui",
            "account_number": "aut",
            "bank_name": "id",
            "bank_code": "rerum",
            "branch": "eum",
            "tax_payer_id": "reprehenderit"
        }
    ]
}
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/user?service_staff=saepe" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"in","new_password":"minima"}'
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/profit-loss-report?location_id=quis&start_date=2018-06-25&end_date=2018-06-25&user_id=ut" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
