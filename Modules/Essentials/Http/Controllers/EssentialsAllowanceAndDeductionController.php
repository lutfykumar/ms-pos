...
class EssentialsAllowanceAndDeductionController extends Controller
{
    ...
    public function create()
    {
        ...
        if (!(auth()->user()->can('superadmin') || $this->moduleUtil->hasThePermissionModuleBusiness($business_id, 'essentials_module')) || !auth()->user()->can('essentials.add_allowance_and_deduction')) {
            abort(403, 'Unauthorized action.');
        }
