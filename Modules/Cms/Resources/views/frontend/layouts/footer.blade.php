        ...
        <div class="row flex-column flex-md-row px-2 justify-content-center">
            @if (isset($__site_details['follow_us']) && !empty($__site_details['follow_us']))
                <div class="flex-grow-1 col">
                    <ul class="block-44__extra-links d-flex list-unstyled p-0" style="font-size: 23px">
            ...
            @endif
            <p
                class="block-41__copyrights col col-md-8 text-xxl-end text-xl-end text-lg-end text-md-end text-sm-center">
                &copy; &nbsp;{{ date('Y') }} &nbsp;{{ config('app.name', 'ultimatePOS') }}. &nbsp;All Rights
                Reserved.
            </p>
        </div>
    </div>
