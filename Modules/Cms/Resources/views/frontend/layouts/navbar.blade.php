    ...
    <nav class="hero-nav position-relative container mx-auto px-0">
        <ul class="nav w-100 list-unstyled align-items-center p-0">
            <li class="hero-nav__item">
                <a href="{{ url('/') }}">
                    <img class="hero-nav__logo" src="{{ $__logo_url }}" change-src-onscroll="{{ $__logo_url }}"
                            ...
                            @if (count($__pages) > 0)
                                <li class="hero-nav__item hero-nav__item--with-dropdown">
                                    <span class="hero-nav__link" tabindex="1" role="button">
                                        ...
                                        <svg class="hero-nav__item-chevron bi bi-chevron-down" width=".8em"
                                            height=".8em" viewBox="0 0 16 16" fill="currentColor"
                                        ...
                                        <div class="row flex-wrap">
                                            <div class="col-lg-12">
                                                @foreach ($__pages as $page)
                                                    <a href="{{ action('\Modules\Cms\Http\Controllers\CmsPageController@showPage', ['page' => $page->slug]) }}"
