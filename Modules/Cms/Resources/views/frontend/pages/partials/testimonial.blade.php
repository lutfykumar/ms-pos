    ...
    <div class="block-20 space-between-blocks">
        <div class="container">
            <div class="col-lg-9 mx-auto text-center px-0 mb-5">
                <p class="block__paragraph--big">Kami memiliki pelanggan yang bahagia</p>
                <h1 class="block__title--big pb-5">Apa Kata Mereka Tentang Kami</h1>
            </div>
                    ...
                    <div class="col-lg-4 mb-1">
                        <div class="testimonial-card-1">
                            <div class="block-20-person">
                                <div class="mb-2">
                                    <img class="block-20-person__avatar"
                                        src="{{ $testimonial->feature_image_url ?? 'https://ui-avatars.com/api/?name=' . $testimonial->title }}"
                                        loading="lazy">
                                </div>
