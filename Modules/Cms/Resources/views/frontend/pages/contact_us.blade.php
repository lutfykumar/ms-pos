            ...
            <div class="row flex-row-reverse">
                <div class="col-lg-6 px-4 px-xl-5 py-3 text-center">
                    <form class="contact-form text-center" id="contact_form">
                        ...
                        <input type="text" name="name" class="contact-form__input" placeholder="Nama Lengkap Anda"
                            required>
                        <input type="number" name="mobile" class="contact-form__input" placeholder="No Hp Anda" required>
                        <input type="email" name="email" class="contact-form__input" placeholder="Email Anda" required>
                        <textarea class="contact-form__input" name="message" placeholder="Pesan Anda" required></textarea>
                            ...
                            <ul class="non-bullet-list mt-2">
                                @foreach ($filtered_contact_us as $filtered_contact)
                                    <li>
                                        ...
                                        <a href="tel:{{ $filtered_contact['num'] }}" class="text-dark text-decoration-none"
                                            target="_blank">
                            ...
                            <ul class="non-bullet-list mt-2">
                                @foreach ($filtered_mail_us as $filtered_mail)
                                    <li>
                                        ...
                                        <a href="mailto:{{ $filtered_mail['email'] }}" target="_blank"
