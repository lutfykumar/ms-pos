    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="box-tools">
            <a class="btn btn-block btn-primary" 
                href="{{action('\Modules\Cms\Http\Controllers\CmsPageController@create', ['type' => $post_type])}}">
                        ...
                        @slot('tool')
                            <div class="box-tools" style="display: flex;">
                                <a class="btn btn-block btn-primary btn-xs"
                                    href="{{action('\Modules\Cms\Http\Controllers\CmsPageController@edit', [$page->id, 'type' => $post_type])}}">
                                    <i class="fa fa-edit"></i>
                                </a>
                                &nbsp;
                                @if(empty($page->layout))
                                    <button data-href="{{action('\Modules\Cms\Http\Controllers\CmsPageController@destroy', [$page->id, 'type' => $post_type])}}" class="btn btn-xs btn-danger delete_page">
