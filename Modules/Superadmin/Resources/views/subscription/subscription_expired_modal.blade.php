<div class="modal-dialog modal-danger" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            @lang('superadmin::lang.subscription_expired_modal_content', ['app_name' => config('app.name')])
        </div>

        <div class="modal-footer">
            <a href="{{ action('\Modules\Superadmin\Http\Controllers\SubscriptionController@index') }}"
                class="btn btn-outline btn-default"><i class="fa fa-refresh"></i> @lang('superadmin::lang.subscribe')</a>
