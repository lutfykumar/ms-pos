<div class="pos-tab-content">
    <div class="row">
        ...
        <div class="col-xs-8 @if (config('backup.backup.destination.disks') != 'dropbox') hide @endif" id="dropbox_access_token_div">
            <div class="form-group">
                {!! Form::label('DROPBOX_ACCESS_TOKEN', __('superadmin::lang.dropbox_access_token') . ':') !!}
                {!! Form::text('DROPBOX_ACCESS_TOKEN', $default_values['DROPBOX_ACCESS_TOKEN'], [
                    'class' => 'form-control',
