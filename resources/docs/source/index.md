...
[Get Postman Collection](https://ultimate-pos.dev/docs/collection.json)
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "https://ultimate-pos.dev/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"libero","ip_address":"molestiae","latitude":"iure","longitude":"voluptatem"}'
...
```bash
curl -X POST \
    "https://ultimate-pos.dev/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"nesciunt","latitude":"consequuntur","longitude":"occaecati"}'
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/holidays?location_id=dolores&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=doloribus&follow_up_type=numquam&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/crm/follow-ups"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X PUT \
    "https://ultimate-pos.dev/connector/api/crm/follow-ups/20" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"architecto","schedule_type":"facere","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=ut&biz_name=voluptatem&mobile_num=3&contact_id=excepturi&order_by=quidem&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "https://ultimate-pos.dev/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"assumenda","mobile_name":"minus","call_type":"call","start_time":"odit","end_time":"quo","duration":"molestiae"}]}'
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=perferendis&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":20,"initial_amount":116899409.7005,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":46929662,"total_card_slips":11,"total_cheques":4,"closing_note":"totam","transaction_ids":"1,2,3"}'
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/contactapi?type=totam&name=dolore&biz_name=rem&mobile_num=10&contact_id=quia&order_by=in&direction=voluptas&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"recusandae","prefix":"veritatis","first_name":"nihil","middle_name":"corporis","last_name":"repellat","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"amet","address_line_2":"omnis","city":"nulla","state":"sit","country":"reiciendis","zip_code":"velit","customer_group_id":"eligendi","contact_id":"porro","dob":"2000-06-13","custom_field1":"est","custom_field2":"est","custom_field3":"maxime","custom_field4":"labore","email":"dolorem","shipping_address":"et","position":"provident","opening_balance":0,"source_id":8,"life_stage_id":18,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "recusandae",
    "prefix": "veritatis",
    "first_name": "nihil",
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"eos","prefix":"inventore","first_name":"reiciendis","middle_name":"porro","last_name":"neque","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"dignissimos","address_line_2":"quod","city":"corporis","state":"possimus","country":"possimus","zip_code":"illum","customer_group_id":"totam","contact_id":"itaque","dob":"2000-06-13","custom_field1":"quis","custom_field2":"totam","custom_field3":"alias","custom_field4":"enim","email":"quidem","shipping_address":"dolor","position":"est","opening_balance":10.3,"source_id":18,"life_stage_id":20,"assigned_to":[]}'
...
```bash
curl -X POST \
    "https://ultimate-pos.dev/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":10,"card_number":"ut","card_holder_name":"doloremque","card_transaction_number":"eius","card_type":"officiis","card_month":"fugiat","card_year":"explicabo","card_security":"laudantium","transaction_no_1":"dolores","transaction_no_2":"quaerat","transaction_no_3":"commodi","cheque_number":"amet","bank_account_number":"tempora","note":"iusto"}'
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/expense?location_id=unde&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=consequatur&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":2,"final_total":32.084225,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":6,"expense_for":20,"contact_id":15,"additional_notes":"odio","is_refund":0,"is_recurring":0,"recur_interval":17,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"qui","recur_repetitions":13,"payment":[{"amount":453.13,"method":"cash","account_id":18,"card_number":"ea","card_holder_name":"voluptatem","card_transaction_number":"amet","card_type":"corporis","card_month":"dolor","card_year":"consequuntur","card_security":"non","transaction_no_1":"molestias","transaction_no_2":"minima","transaction_no_3":"similique","note":"magni","cheque_number":"dolores"}]}'
...
let body = {
    "location_id": 2,
    "final_total": 32.084225,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 6,
    "expense_for": 20,
    "contact_id": 15,
    "additional_notes": "odio",
    "is_refund": 0,
    "is_recurring": 0,
    "recur_interval": 17,
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "https://ultimate-pos.dev/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":5060168.30889,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":15,"expense_for":4,"contact_id":16,"additional_notes":"amet","is_recurring":0,"recur_interval":19,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"ipsum","recur_repetitions":14,"payment":[]}'
...
let body = {
    "final_total": 5060168.30889,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 15,
    "expense_for": 4,
    "contact_id": 16,
    "additional_notes": "amet",
    "is_recurring": 0,
    "recur_interval": 19,
    "recur_interval_type": "months",
    "subscription_repeat_on": 15,
    "subscription_no": "ipsum",
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/expense-refund?location_id=modi&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=dolorem&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/product?order_by=sapiente&order_direction=labore&brand_id=nulla&category_id=vel&sub_category_id=earum&location_id=vel&selling_price_group=qui&name=quia&sku=aliquid&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/product"
);

let params = {
    "order_by": "sapiente",
    "order_direction": "labore",
    "brand_id": "nulla",
    "category_id": "vel",
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/product/1?selling_price_group=earum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/product/1"
);

let params = {
    "selling_price_group": "earum",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/variation/2?product_id=incidunt&location_id=voluptate&brand_id=consequatur&category_id=ducimus&sub_category_id=aut&not_for_selling=consequatur&name=quas&sku=ratione&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/variation/2"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/sell?location_id=voluptatibus&contact_id=commodi&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=libero&service_staff_id=natus&shipping_status=ordered&only_subscriptions=consequuntur&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/sell"
);

let params = {
    "location_id": "voluptatibus",
    "contact_id": "commodi",
    "payment_status": "paid",
    "start_date": "2018-06-25",
    "end_date": "2018-06-25",
    "user_id": "libero",
    "service_staff_id": "natus",
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":5,"contact_id":19,"transaction_date":"2020-07-22 15:48:29","invoice_no":"non","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":4,"discount_amount":10,"discount_type":"fixed","sale_note":"inventore","staff_note":"beatae","commission_agent":19,"shipping_details":"Express Delivery","shipping_address":"modi","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":13,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":3,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"ut","recur_repetitions":20,"rp_redeemed":20,"rp_redeemed_amount":13.5,"types_of_service_id":9,"service_custom_field_1":"possimus","service_custom_field_2":"porro","service_custom_field_3":"aliquid","service_custom_field_4":"sint","service_custom_field_5":"rem","service_custom_field_6":"voluptate","round_off_amount":1934.17977562,"table_id":8,"service_staff_id":10,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":9,"note":"ex"}],"payments":[{"amount":453.13,"method":"cash","account_id":12,"card_number":"qui","card_holder_name":"quibusdam","card_transaction_number":"qui","card_type":"ea","card_month":"nulla","card_year":"in","card_security":"velit","transaction_no_1":"consequatur","transaction_no_2":"aperiam","transaction_no_3":"quasi","bank_account_number":"officiis","note":"eveniet","cheque_number":"quis"}]}]}'
    ...
    "sells": [
        {
            ...
            "service_custom_field_1": "possimus",
            "service_custom_field_2": "porro",
            "service_custom_field_3": "aliquid",
            "service_custom_field_4": "sint",
            "service_custom_field_5": "rem",
            "service_custom_field_6": "voluptate",
            "round_off_amount": 1934.17977562,
            "table_id": 8,
            "service_staff_id": 10,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "transaction_no_3": "quasi",
                    "bank_account_number": "officiis",
                    "note": "eveniet",
                    "cheque_number": "quis"
                }
            ]
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "https://ultimate-pos.dev/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":18,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":18,"discount_amount":10,"discount_type":"fixed","sale_note":"ut","staff_note":"sunt","sells":[{"is_suspend":false}],"commission_agent":1,"shipping_details":"Express Delivery","shipping_address":"praesentium","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":11,"pay_term_number":1,"pay_term_type":"months","is_recurring":0,"recur_interval":17,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"et","recur_repetitions":12,"rp_redeemed":5,"rp_redeemed_amount":13.5,"types_of_service_id":12,"service_custom_field_1":"unde","service_custom_field_2":"alias","service_custom_field_3":"accusantium","service_custom_field_4":"dolorem","service_custom_field_5":"beatae","service_custom_field_6":"aut","round_off_amount":5037826,"table_id":2,"service_staff_id":16,"change_return":0,"change_return_id":18,"products":[{"sell_line_id":13,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":15,"discount_amount":0,"discount_type":"percentage","sub_unit_id":4,"note":"et"}],"payments":[{"payment_id":9,"amount":453.13,"method":"cash","account_id":2,"card_number":"ut","card_holder_name":"reprehenderit","card_transaction_number":"voluptas","card_type":"molestiae","card_month":"hic","card_year":"non","card_security":"a","transaction_no_1":"voluptas","transaction_no_2":"necessitatibus","transaction_no_3":"quam","note":"ad","cheque_number":"eaque","bank_account_number":"modi"}]}'
    ...
    "payments": [
        {
            ...
            "transaction_no_2": "necessitatibus",
            "transaction_no_3": "quam",
            "note": "ad",
            "cheque_number": "eaque",
            "bank_account_number": "modi"
        }
    ]
}
...
```bash
curl -X DELETE \
    "https://ultimate-pos.dev/connector/api/sell/eligendi" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "https://ultimate-pos.dev/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":9,"transaction_date":"2020-5-7 15:20:22","invoice_no":"itaque","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":20,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "https://ultimate-pos.dev/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":2,"shipping_status":"ordered","delivered_to":"nostrum"}'
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/table?location_id=aliquam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/table"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/taxonomy?type=nesciunt" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/user/loggedin"
);
...
```bash
curl -X POST \
    "https://ultimate-pos.dev/connector/api/user-registration" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"asperiores","first_name":"maxime","last_name":"ut","email":"sint","is_active":"dolores","user_type":"et","crm_contact_id":18,"allow_login":true,"username":"iste","password":"quae","role":18,"access_all_locations":true,"location_permissions":[],"cmmsn_percent":"mollitia","max_sales_discount_percent":"omnis","selected_contacts":false,"selected_contact_ids":[],"dob":"esse","gender":"qui","marital_status":"commodi","blood_group":"facere","contact_number":"labore","alt_number":"est","family_number":"culpa","fb_link":"et","twitter_link":"eaque","social_media_1":"consectetur","social_media_2":"fuga","custom_field_1":"libero","custom_field_2":"unde","custom_field_3":"excepturi","custom_field_4":"quo","guardian_name":"ut","id_proof_name":"ea","id_proof_number":"consequuntur","permanent_address":"eligendi","current_address":"nihil","bank_details":[{"account_holder_name":"earum","account_number":"omnis","bank_name":"nihil","bank_code":"ut","branch":"qui","tax_payer_id":"et"}]}'
...
let body = {
    ...
    "blood_group": "facere",
    "contact_number": "labore",
    "alt_number": "est",
    "family_number": "culpa",
    "fb_link": "et",
    "twitter_link": "eaque",
    "social_media_1": "consectetur",
    "social_media_2": "fuga",
    "custom_field_1": "libero",
    "custom_field_2": "unde",
    "custom_field_3": "excepturi",
    "custom_field_4": "quo",
    "guardian_name": "ut",
    "id_proof_name": "ea",
    "id_proof_number": "consequuntur",
    "permanent_address": "eligendi",
    "current_address": "nihil",
    "bank_details": [
        {
            "account_holder_name": "earum",
            "account_number": "omnis",
            "bank_name": "nihil",
            "bank_code": "ut",
            "branch": "qui",
            "tax_payer_id": "et"
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/user?service_staff=quae" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/user"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/user/1"
);
...
```bash
curl -X POST \
    "https://ultimate-pos.dev/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"cumque","new_password":"similique"}'
...
```bash
curl -X POST \
    "https://ultimate-pos.dev/connector/api/forget-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/profit-loss-report?location_id=velit&start_date=2018-06-25&end_date=2018-06-25&user_id=tempora" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "https://ultimate-pos.dev/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://ultimate-pos.dev/connector/api/notifications"
);
