                ...
                <div class="col-md-4 mt-15">
                    <label class="radio-inline">
                        <input type="radio" name="contact_type_radio" id="inlineRadio1" value="individual"
                            @if ($contact->contact_type_radio == 'individual') checked @endif>
                        @lang('lang_v1.individual')
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="contact_type_radio" id="inlineRadio2" value="business" @if ($contact->contact_type_radio == 'business') checked @endif>
